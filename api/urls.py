...
urlpatterns = [
    ...
    path('inventory/', views.InventoryItemListCreate.as_view(), name='inventory-list-create'),
    path('inventory/<int:pk>/', views.InventoryItemDetail.as_view(), name='inventory-detail'),
